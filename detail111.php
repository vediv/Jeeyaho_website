...
function buildMusicTabItems(JSONobject)
{
        ...
        for(var i = 0; i < len ; i++)
        {
         ...
         {
           var cl="active-bar"; }
           tab+='<div class="baritem-container"><span class="bar-item '+cl+'" id="TAB'+Parent_id+'" onclick=calltabData(\''+Parent_id+'\',\''+Parent_name+'\') >'+Parent_id+''+Parent_name+'</span></div>';
        }
        tab+='</div>';
        var activeId="";
...
function calltabData(cid,cname)
{
      alert(cid+"--"+cname);
