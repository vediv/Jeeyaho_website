...
<body onload="initMusic(<?php echo $catID; ?>)"  class="">
...
<div class="w3-row header header-menu barSubItems1" style="margin-top: 10px;">
   ...
   <div class="main-container w3-row-padding" >
            <div id="music-result" class="tabs" style="margin-top:20px;">
               ...
               <div class="w3-col s12 m3 l3 lazy-container">
                   <div class="w3-card-2">
                  <img src="images/placeholder1.png" class="w3-image"></a>
                      <div class="card-text ">
...
function getDataFilmMusic1(pcid)
{
   ...
   $.ajax({
    ...
    success: function (JSONresponse) {
      ...
      _('load_more_button').style.visibility = '';
      if(paging==null)
