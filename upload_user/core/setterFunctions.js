	  ...
	  if(Container=='category-home'){
	     ...
	     for(var i=0; i < catinfo_len; i++)
	     {
		    ...
		    // alert(Parent_id);
		     ...
		     control+='<div class="w3-display-middle w3-display-middle-new"  style="border-bottom: 2px solid #3498db;"><a href="episode/'+Parent_id+'"><h6 style="font-weight: 700 !important;" title="'+name+'">'+Parent_name+' </h6></a> </div> <br />';
		     }
		     control+='</div>';
	     }
	     control +='</div>';
...
function buildMyProflie(JSONobject, Container)
 ...
 function buildMoviesCategoryHtml(JSONobject, Container)
 {
        ...
        control+='<div class="w3-card-2">';
        control+='<a style="cursor:pointer;"><img class=" w3-image lazy"  data-src="'+thumburl+'"  onCLick="viewMedia(\''+entryid+'\',\''+plan+'\')" ></a>';
        control+='<span class="duration">'+msToTime(duration)+'</span>';
         control+='<span class="'+planClass+' " style="bottom: 23%;  z-index: 1; position: absolute;">'+plandetail+'</span>';
