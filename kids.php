...
$parentcatid=isset($_GET['pcatid'])?$_GET['pcatid']:'';
 ...
 ?>
<body onload="initKids()" id="get_token" class="">
...
<div class="w3-row channel-container darkBg ">
    <div class="main-container w3-row-padding" >
             <div id="kids_result" class="tabs" style="margin-top:20px;">
...
function buildDramaTabItems(JSONobject)
    {
        ...
        if(len>0)
        {
        	...
        	if(Parent_id==pcatid){ getDataWithCategory(Parent_id,"kids_result"); $("#load_more_button").hide();
        	  var containerNew="kids_result";
             }
            if(pcatid=='' && subCount>0)
            {
            	
            	$("#load_more_button").hide();
            	getDataWithCategory(Parent_id,"kids_result"); var containerNew="kids_result";
