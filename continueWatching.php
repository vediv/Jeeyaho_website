...
<body onload="initContinueWatching()" id="get_token">
    ...
    <div class="w3-seprator-top"></div> <!-- 60px top-->
     ...
     <div class="w3-row darkBar">
        <div class="main-container w3-row-padding ">
            <ol class="w3-breadcrumb"><li><a href="<?php echo $baseUrl?>">HOME</a> / </li><li><a href="" class="last"> Continue watching</a></li></ol>
        </div>    
  </div>
     ...
     <div class="w3-row fullHeight" >
         ...
         <div class="main-container w3-row-padding" id="continue-watching">
