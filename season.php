...
?>
<body onload="initSeason(<?php echo $patID; ?>)" id="get_token">
...
var total_pages =0;
$.post(GET_INFO, {page: track_click,partnerid:PARTNER_ID,categoryid:catIdNew,limit:limit,countrycode:countrycode}, function(JSONresponse){
