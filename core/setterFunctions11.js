...
function buildMenu(JSONobject, Container,pagename,loginstatus,userid)
{
    ...
    for ( var i = 0; i < items ; i++)
    {
       ...
       // alert(catID);
        ...
        else if((viewType==2 && catname=='DRAMA SERIES') || (viewType=="2" && catname=='DRAMA SERIES'))
        {
            url=baseUrl+"/drama";
            sessionStorage.setItem("drama_id",catID);
        }
       ...
       else if((viewType==2 && catname=='LIFESTYLE') || (viewType=="2" && catname=='LIFESTYLE'))
        {
            url=baseUrl+"/lifestyle";
            sessionStorage.setItem("lifestyle_id",catID);
        }
        ...
        else if((viewType==2 && catname=='KIDS') || (viewType=="2" && catname=='KIDS'))
        {
            url=baseUrl+"/kids";
