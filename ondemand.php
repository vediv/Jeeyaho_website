...
if($subCatID=='empty')
{
	 $categoryIDD=0;  $catName=''; $vcatID='';
}
if($subCatID!='empty')
{
    	
   $categoryIDD=$subCatID; $catName; $vcatID='';
}
if(!empty($VideocategorieID))
{
	$vcatID= $VideocategorieID; $catName; $vcatID; $categoryIDD;
}	
    ...
    <div class="w3-seprator-top"></div> <!-- 60px top-->
     ...
     <div class="w3-row darkBar">
        <div class="main-container w3-row-padding ">
            <ol class="w3-breadcrumb" id="cat_nav"><li><a href="<?php echo $baseUrl ;?>/index">HOME</a> / </li><li><a href="<?php echo $baseUrl ;?>/ondemand">CATEGORY</a> / </li></ol>
        </div>    
  </div>
...
<div class="w3-row fullHeight">
   <div class="main-container w3-row-padding w3-container">
            ...
            <div class="w3-col l9 s12 m9">
                ...
                <div class="w3-prussian_blue w3-container fullHeight relative">
                    <h3 id="category-title">All Categories </h3> 
                    <hr>
                        ...
                        <!--div class="w3-row " >
                          <?php for($i=0;$i<3;$i++) : ?>
                            ...
                            <div class="w3-card-2 vidThumb">
                              <img class="w3-image" src="<?php echo $baseUrl ;?>/images/banners/placeholderS.jpg" >
            ...
            <div class="w3-col s12 m12 l12 w3-center w3-hide" id="loadMore"><button class="adore-btn" onclick="getVideoIncategory(catVideoID,catVidPg,12)">Load More</button></div>
 ...
 <!--!ads--->
             ...
             <div class="w3-col l3 s12 m3 ">
                    <div class="w3-content ">
                        <div class="w3-prussian_blue w3-row-padding relative" style="min-height: 230px;">
                        <h3 >Category List</h3>
                        <hr>
                        ...
                        <script>
                            ...
                            {
                                  var sMenuObj=JSON.parse(sessionStorage.getItem("sideMenu"));
                                  buildCategoryTree(sMenuObj, "sidebar",catName,subCatID,catVideoID);
                            }
                      
                        </script>
                        
                <div class="w3-seprator"></div>
                <div class="w3-prussian_blue w3-row-padding ">
                     <h3 >Social Fans</h3>
                        <hr>      
